    ...
    protected override void AccessData(JSONObject jsonObj)
    {
        switch (jsonObj.type)
        {
            case JSONObject.Type.OBJECT:
                ...
                Config.HydrologyFlowMemoryWeight = ParseFloat(data, "HydrologyFlowMemoryWeight", 0.35f);
                Config.HydrologyFlowShadowWeight = ParseFloat(data, "HydrologyFlowShadowWeight", 0.45f);
                Config.HydrologyFlowShadowSlopeWeight = ParseFloat(data, "HydrologyFlowShadowSlopeWeight", 0.35f);
                Config.HydrologyContinuityWeight = ParseFloat(data, "HydrologyContinuityWeight", 0.35f);
                Config.HydrologyPressureBlend = ParseFloat(data, "HydrologyPressureBlend", 0.35f);
                Config.HydrologyPressureGradientClamp = ParseFloat(data, "HydrologyPressureGradientClamp", 0.18f);
                ...
                Config.RiparianSmoothBlend = ParseFloat(data, "RiparianSmoothBlend", 0.6f);
                ...
                Config.LakeVarianceWeight = ParseFloat(data, "VarianceWeight", 0.25f);
                ...
                Config.OutflowStabilityWeight = ParseFloat(data, "OutflowStabilityWeight", 0.3f);
                Config.LakeWetlandBufferRadius = ParseInt(data, "LakeWetlandBufferRadius", 2);
                Config.FlowSeepageWeight = ParseFloat(data, "FlowSeepageWeight", 0.25f);
