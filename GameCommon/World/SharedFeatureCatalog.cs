...
namespace GameCommon.World
{
    ...
    public static class SharedFeatureCatalog
    {
        ...
        /// (recharge bridge coupling + adaptive queue-limit harmonization + map-control v60).
        /// </summary>
        public const string HydrologySignature = "2026-02-26-hydrology-riverlake-cave-v56";

        /// <summary>
        /// Shared minimum profile version expected by server/client/probe paths.
        /// </summary>
        public const int MapControlProfileVersion = 60;
