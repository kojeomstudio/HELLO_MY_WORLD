...
namespace GameCommon.World
{
    ...
    public static class SharedFeatureCatalog
    {
        ...
        private static readonly List<SharedFeatureDescriptor> features = new()
        {
            ...
            new SharedFeatureDescriptor(
                "S21-CONTENT-03",
                "Lake Floodplain Link + Karst Retention Relay v80",
                FeatureCategory.Content,
                FeatureLayer.Shared,
                new[]
                {
            ...
            new SharedFeatureDescriptor(
                "S21-UTIL-02",
                "Data-Driven Config Parity + Map-Control v84",
                FeatureCategory.Utility,
                FeatureLayer.Shared,
                new[]
                {
            ...
            new SharedFeatureDescriptor(
                "S21-UTIL-04",
                "Hydrology Queue + Spillway Resilience Scale (Server/Client Parity)",
                FeatureCategory.Utility,
                FeatureLayer.Shared,
                new[]
                {
