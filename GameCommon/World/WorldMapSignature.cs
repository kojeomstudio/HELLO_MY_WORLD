    ...
    public static class WorldMapSignature
    {
        public static string Compute(WorldMapSignatureContext context)
        {
            ...
            var builder = new StringBuilder()
                ...
                .Append(context.RiverTributaryCaptureWeight).Append('|')
                .Append(context.RiverAvulsionResistance).Append('|')
                ...
                .Append(context.LakeSpillRetentionWeight).Append('|')
                .Append(context.LakeSpillwayContinuityWeight).Append('|')
                .Append(context.CaveEntranceFlowDampening).Append('|')
                .Append(context.CaveGroundwaterConnectivityWeight).Append('|')
                .Append(context.CaveVentilationBias).Append('|')
