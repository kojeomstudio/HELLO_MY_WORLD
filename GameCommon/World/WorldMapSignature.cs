    ...
    public static class WorldMapSignature
    {
        public static string Compute(WorldMapSignatureContext context)
        {
            ...
            var builder = new StringBuilder()
                ...
                .Append(context.LakesMaxRadius).Append('|')
                ...
                .Append(context.LakeOutflowStabilityWeight).Append('|')
                ...
                .Append(context.RiverSeamFillStrength).Append('|')
                ...
                .Append(context.LakeOutflowCarveDepth).Append('|')
                ...
                .Append(context.PreviewQueueShockAbsorberWeight);
