...
namespace GameServerApp.World.Generation.Content
{
    ...
    public class TerrainContentLayer : IContentLayer
    {
        ...
        {
            if (typeof(T) == typeof(CaveConfig))
            {
                return (T)(object)_config.Caves;
            }

            if (typeof(T) == typeof(WaterConfig))
            {
                return (T)(object)_config.Water;
            }

            if (typeof(T) == typeof(LakeConfig))
            {
                return (T)(object)_config.Lakes;
            }
