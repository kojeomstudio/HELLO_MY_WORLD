...
namespace GameServerApp.World
{
    ...
    public sealed class WorldGenerationConfig
    {
        ...
        public int MapControlProfileVersion { get; set; } = 14;
    ...
    public sealed class WaterConfig
    {
        ...
        public int HydrologyReservoirIterations { get; set; } = 3;
        ...
        public double HydrologyFlowGain { get; set; } = 0.6;
        public double HydrologyFlowShadowWeight { get; set; } = 0.52;
        public double HydrologyFlowShadowSlopeWeight { get; set; } = 0.42;
        public double HydrologyContinuityWeight { get; set; } = 0.35;
        public double HydrologyPressureBlend { get; set; } = 0.42;
        public double HydrologyPressureGradientClamp { get; set; } = 0.22;
        public double HydrologyEdgeFlowBias { get; set; } = 0.42;
        public double HydrologyEdgeTangentWeight { get; set; } = 0.45;
        public double HydrologyEdgeFlowLockWeight { get; set; } = 0.44;
        public int HydrologyEdgeBlendRadius { get; set; } = 6;
        public int HydrologyWatershedStitchRadius { get; set; } = 2;
        public double HydrologyWatershedStitchWeight { get; set; } = 0.42;
        public int HydrologyEdgeStabilityIterations { get; set; } = 4;
        public double HydrologyEdgeStabilityWeight { get; set; } = 0.44;
        public double HydrologyEdgeVarianceClamp { get; set; } = 0.30;
        public double HydrologyEdgeFluxBlend { get; set; } = 0.6;
        public double HydrologyVarianceBlend { get; set; } = 0.6;
        public double HydrologyVarianceClamp { get; set; } = 0.6;
        public double HydrologyEdgeNormalizationBlend { get; set; } = 0.42;
        public int HydrologyEdgeNormalizationIterations { get; set; } = 2;
        public double HydrologyFlowMemoryWeight { get; set; } = 0.45;
        ...
        public int HydrologySeamRelaxIterations { get; set; } = 4;
        public double HydrologySeamRelaxBlend { get; set; } = 0.56;
        public double RiverBankErosionWeight { get; set; } = 0.16;
        public double LakeRimErosionWeight { get; set; } = 0.42;
        public double RiverReliefPenaltyWeight { get; set; } = 0.34;
        ...
        public int RiparianBufferRadius { get; set; } = 2;
        public double RiverFlowAlignmentWeight { get; set; } = 0.32;
        ...
        public double RiverAnisotropyDamping { get; set; } = 0.34;
        public double RiverMeanderJitter { get; set; } = 0.22;
        public double RiverBankStabilityClamp { get; set; } = 0.42;
        public double LakeInflowBlendWeight { get; set; } = 0.56;
        public double RiverConfluenceBoost { get; set; } = 0.5;
        public double RiverEdgeFeather { get; set; } = 0.58;
        public int RiverMouthSmoothRadius { get; set; } = 5;
        public double RiverDeltaWetlandStrength { get; set; } = 0.55;
    ...
    public sealed class CaveConfig
    {
        ...
        public double MoistureRetentionWeight { get; set; } = 0.44;
        public double MoistureFlowClamp { get; set; } = 0.6;
        public double RiparianCaveGuardWeight { get; set; } = 0.46;
        public double EdgeSealStrength { get; set; } = 0.6;
        public double SupportPillarChance { get; set; } = 0.3;
        public int RiparianPlugDepth { get; set; } = 2;
        public double CeilingStabilityWeight { get; set; } = 0.38;
        public double CeilingMoistureWeight { get; set; } = 0.36;
        public double CeilingMoistureClamp { get; set; } = 0.38;
    }
    ...
    public sealed class LakeConfig
    {
        ...
        public double SpawnWeightBias { get; set; } = 0.32;
        public double ShorelineBlend { get; set; } = 0.7;
        ...
        public double OutflowSealWeight { get; set; } = 0.42;
        public int ShelfDepth { get; set; } = 2;
        public int WetlandBufferRadius { get; set; } = 4;
        public double FlowSeepageWeight { get; set; } = 0.54;
        public double VarianceWeight { get; set; } = 0.36;
        public double OutflowStabilityWeight { get; set; } = 0.52;
    }
}
