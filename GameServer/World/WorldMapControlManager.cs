...
namespace GameServerApp.World
{
    ...
    {
        private const string PipelineVersion = "2026-01-15-hydrology-envelope";
        ...
        private WorldMapControlProfile EnsureProfile(out bool profileChanged)
        {
            ...
            if (loaded == null || configNewerThanProfile || profileHashDrift || versionMismatch || profileFileUpdated || profileContentChanged)
            {
