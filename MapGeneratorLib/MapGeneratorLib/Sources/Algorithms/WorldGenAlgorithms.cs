...
namespace MapGenLib
{
    ...
    public class WorldGenAlgorithms
    {
        ...
        public static int HydrologyReservoirIterations = 3;
        public static float HydrologyReservoirBlend = 0.38f;
        public static int CaveStabilitySmoothIterations = 4;
        ...
        public static float HydrologyEdgeStabilityWeight = 0.44f;
        ...
        public static int HydrologySeamRelaxIterations = 4;
        ...
        public static int RiparianBufferRadius = 2;
        public static float RiverBankErosionWeight = 0.16f;
        public static float LakeRimErosionWeight = 0.42f;
        ...
        public static float RiparianCaveGuardWeight = 0.46f;
        public static float CaveSupportHydrationBias = 0.42f;
        public static float CaveSupportFlowBias = 0.20f;
        public static float SupportPillarChance = 0.3f;
        public static float CaveMoistureRetentionWeight = 0.44f;
        public static float LakeRiverProximitySuppression = 0.35f;
        public static float LakeInflowBlendWeight = 0.56f;
        public static float CaveEdgeSealStrength = 0.6f;
        ...
        public static float CaveCeilingMoistureWeight = 0.36f;
        public static float CaveCeilingStabilityWeight = 0.38f;
        public static float CaveCeilingMoistureClamp = 0.38f;
