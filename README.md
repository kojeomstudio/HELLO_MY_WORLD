...
## 현재 기준 (Session 159)
- Hydrology signature: `2026-03-12-hydrology-riverlake-cave-v82`
- Map control profile version: `86`
- Queue policy version: `39`
- Feature manifest:
...
## 문서
- Session 159 상세 보고서: `docs/2026-03-12-session-159-implementation-report.md`
- Session 159 작업 계획: `plans/2026-03-12-session-159-comprehensive-work-plan.md`
...
자세한 내용은 `config/minecraft_feature_client_server_core_content_util_2026-03-12-session-159.json` 참조.
