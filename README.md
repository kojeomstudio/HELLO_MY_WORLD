...
## Recent Updates
- 2025-12-12: Edge hydrology seam blending now samples multi-neighbor rings in both `WorldManager` and MapGeneratorLib to reduce cave/river/lake border artifacts; `ProtocolValidator` enforces generated Parser availability to catch stale protobuf `using` references; refreshed core/content/util matrix in `docs/minecraft_feature_core_content_util_2025-12-12.md` and `_latest`.
