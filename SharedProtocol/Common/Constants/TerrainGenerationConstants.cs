...
public static class TerrainGenerationConstants
{
    ...
    /// </summary>
    public const SharedProtocol.Common.Enums.TerrainGenerationEnums.TerrainQualityLevel DefaultQuality =
        SharedProtocol.Common.Enums.TerrainGenerationEnums.TerrainQualityLevel.Medium;
    
    /// <summary>
    /// Default terrain generation mode
    /// </summary>
    public const SharedProtocol.Common.Enums.TerrainGenerationEnums.TerrainGenerationMode DefaultMode =
        SharedProtocol.Common.Enums.TerrainGenerationEnums.TerrainGenerationMode.Standard;
