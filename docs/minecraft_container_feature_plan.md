...
| C3 | Server | Persist slot mutations & broadcast diffs via ContainerSystem | C1, C2 | Logic exists but needs serialization plumbing | In Progress |
...
1. Finish C3 by wiring persistence verification + broadcast smoke test.
