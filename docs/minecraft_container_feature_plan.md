...
| C5 | Client | Bind ContainerManager events to UI prefabs (chest panel MVP) | C4 | `ContainerPanelUI` + `ContainerSlotView` scripts ready; needs prefab wiring | In progress |
...
- [ ] Hook ContainerPanelUI into the HUD prefab (assign references, create slot prefab, verify open/close flow). *Scaffolding scripts landed 2025-10-15.*
