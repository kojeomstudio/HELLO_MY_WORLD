...
| DONE | Weather broadcast scheduling | Server broadcasts time and weather snapshots consumed by Unity controllers. |
...
3. [Done] Task-10A/10B/10C/10D — Day/night lighting, weather FX, and HUD bindings implemented in Unity.
...
7. [Todo] Task-10E — Provide default scene bindings and prefabs for the weather controller.
