...
Current feature split and rollout order across server and Unity client. Mirrors `docs/minecraft_feature_core_content_util_2025-11-30.md`; update that dated file when scope changes.
...
3) Utility/tooling: keep configs, generated protobufs, and data tables in lockstep; add metrics/recordings around world map control.  # Minecraft Core / Content / Utility (current)
