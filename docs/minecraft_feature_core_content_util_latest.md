# Minecraft Core/Content/Util Latest (2026-03-14, Session 167)
...
3. World map control profile/version synchronization (`MapControlProfileVersion=91`).
4. Queue-policy runtime controls including `queueAlluvialRelayWeight` + `queueKarstSpillwayWeight` + `queueHyporheicExchangeWeight`.

## Content (terrain)
1. Cave generation v87: hyporheic exchange seal bridge applied.
2. River generation v87: hyporheic exchange relay bridge applied.
3. Lake generation v87: hyporheic storage balancing bridge applied.
