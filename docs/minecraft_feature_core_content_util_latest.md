Current feature split and rollout order across server and Unity client. Updated 2025-12-30; see `docs/minecraft_feature_core_content_util_2025-12-30.md` for the snapshot. This iteration adds a shared hydrology gradient cache (server + MapGeneratorLib) that guides caves/rivers/lakes along downhill seams while keeping proto guards in place.
