...
### 1. 문서 검토 및 삭제
- [ ] docs 경로의 오래된 문서 검토 (2025년 작성 문서, 2026년 초반 중복 문서)
- [ ] plans 경로의 완료된 오래된 작업 계획 문서 검토
- [ ] minetest 서브모듈 기준으로 정합성 부족한 문서 식별

### 2. 아키텍처 검토
- [ ] minetest 서브모듈 구조 분석
- [ ] 현재 Unity 클라이언트 아키텍처와 비교
- [ ] 개선 필요 사항 식별

### 3. 코드 컴파일 테스트
- [ ] SharedProtocol 빌드 테스트
- [ ] GameServer 빌드 테스트
